...
- Service Layer: [`AppService`](apps/backend/src/app.service.ts), [`TenantsService`](apps/backend/src/tenants/tenants.service.ts), [`LLMOrchestratorService`](apps/backend/src/ai/services/llm-orchestrator.service.ts) (NEW), [`ConversationService`](apps/backend/src/ai/services/conversation.service.ts) (NEW), [`AppointmentsService`](apps/backend/src/appointments/appointments.service.ts)
- AI Tool Pattern (NEW): [`CheckAvailabilityTool`](apps/backend/src/ai/tools/availability.tool.ts), [`BookAppointmentTool`](apps/backend/src/ai/tools/booking.tool.ts), [`ListServicesTool`](apps/backend/src/ai/tools/services.tool.ts)
- Controller: [`AppController`](apps/backend/src/app.controller.ts), [`WabaController`](apps/backend/src/waba/waba.controller.ts), [`TenantsController`](apps/backend/src/tenants/tenants.controller.ts), [`AppointmentsController`](apps/backend/src/appointments/appointments.controller.ts)
