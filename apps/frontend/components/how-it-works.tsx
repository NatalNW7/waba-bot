    ...
    <section id="how-it-works" className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">Três passos simples para agendamentos automatizados</p>
        </div>
              ...
              >
                <div
                  className={`bg-secondary p-8 rounded-2xl text-center transition-all duration-300 ${
                    hoveredIndex === index ? "shadow-xl scale-105 bg-primary/5" : "shadow-md"
                  }`}
                >
