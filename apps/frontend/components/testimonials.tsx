...
const testimonials = [
  ...
  {
    quote: "Meus clientes adoram como é fácil agendar. Eu adoro não passar horas ao telefone. É vantajoso para todos.",
    author: "Carlos Mendes",
    role: "Barbeiro Master, Urban Cuts",
  },
  {
    quote: "Só os lembretes automatizados já se pagaram. Passamos de 20% de faltas para menos de 5%.",
    author: "Ana Costa",
    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">Resultados reais de negócios reais</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-secondary p-8 rounded-2xl relative">
              ...
              <p className="text-foreground leading-relaxed mb-6 relative z-10">"{testimonial.quote}"</p>
        ...
        <div className="mt-16 max-w-3xl mx-auto bg-primary/10 border-2 border-primary/20 rounded-2xl p-8 text-center">
          ...
          <div className="text-xl font-semibold mb-2">Mais agendamentos em 30 dias</div>
          <div className="text-muted-foreground">Resultado médio entre nossos parceiros de salão</div>
        </div>
      </div>
    </section>
  )
